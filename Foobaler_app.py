...
if submitted:
    ...
    st.altair_chart(sentiment_chart, width=True)
    ...
    st.dataframe(recent_a, width=True)
    ...
    st.altair_chart(form_chart_a, width=True)
    ...
    st.dataframe(recent_b, width=True)
    ...
    st.altair_chart(form_chart_b, width=True)
    ...
    if h2h.empty:
        ...
        st.dataframe(h2h[['date','team_a','score_a','team_b','score_b','competition','winner']], width=True)
    ...
    if not h2h.empty:
        ...
        st.altair_chart(h2h_chart, width=True)
    ...
    st.altair_chart(comparison_chart, width=True)
